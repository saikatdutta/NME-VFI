...
class lateral_block(nn.Module):
	...
	def __init__(self, cin , cout, kernel_size = (3,3,3), stride = (1,1,1), padding = (1,1,1),  res_conn = True):
...
class down_block(nn.Module):
	...
	def __init__(self, cin , cout, kernel_size = (3,3,3), padding = (1,1,1)):
...
class up_block(nn.Module):
	...
	def __init__(self, cin, cout, kernel_size = (3,3,3), stride = (1,1,1), padding = (1,1,1) ):
